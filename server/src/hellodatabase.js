...
MongoClient.connect(url, function(err, db) {
  if (err) {
    ...
    mongoExample(db);
    //this is where we kick off other actions that use the database
  }
});

//If your program needs to do anything with the database connection, you will need to kick it off in the callback function we provided./**
